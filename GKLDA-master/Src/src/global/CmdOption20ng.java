...
public class CmdOption20ng {
	...
	public String inputCorporeaDirectory = "../Data/Input/nips";

	@Option(name = "-know", usage = "Specify the file path of knowledge")
	public String inputKnowledgeFilePath = "../Data/Input/Knowledge/nips_must.txt";

	@Option(name = "-o", usage = "Specify the output root directory of the program")
	public String outputRootDirectory = "../Data/Output/nips/";
	...
	public int sampleLag = -1; // -1 means only sample the last one.
	...
	public int twords = 10; // Print out top words ranked by probabilities per
							// each topic. -1: print out all words under topic.

	public CmdOption20ng getSoftCopy() {
		CmdOption20ng cmdOption2 = new CmdOption20ng();
