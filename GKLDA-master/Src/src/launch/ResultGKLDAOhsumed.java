...
import utility.PMIByIndexOhsumed;
...
public class ResultGKLDAOhsumed {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			File dir = new File("../Data/Output/ohsumed/");

			Common.deleteDir(dir);

			MainEntryOhsumed.main(args);

			String[] args_new = new String[2];

			args_new[0] = "ohsumed";

			args_new[1] = "file//vocab_ohsumed.txt";

			double pmi = PMIByIndexOhsumed.main(args_new);
			...
			File file = new File("file//ohsumed.txt");
			...
			file = new File("..//Data//Output//ohsumed//LearningIteration1//DomainModels//ohsumed//ohsumed.dtdist");
			...
			ReadWriteFile.writeFile("file//train_gklda_ohsumed.arff", training_data);

			ReadWriteFile.writeFile("file//test_gklda_ohsumed.arff", test_data);

			/*
			 * 读训练集
			 */

			file = new File("file//train_gklda_ohsumed.arff");
			...
			file = new File("file//test_gklda_ohsumed.arff");
		...
		ReadWriteFile.writeFile("file//gklda_ohsumed_30.txt", sb.toString());
