...
public class MainEntryOhsumed {

	public static void main(String[] args) {

		CmdOption20ng cmdOption = new CmdOption20ng();

		cmdOption.inputCorporeaDirectory = "../Data/Input/ohsumed";

		cmdOption.inputKnowledgeFilePath = "../Data/Input/Knowledge/ohsumed_must.txt";

		cmdOption.outputRootDirectory = "../Data/Output/ohsumed/";
