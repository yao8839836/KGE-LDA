...
public class VoseAlias {
	...
	public void generateTable() {
		...
		// 4. While Small and Large are not empty : (Large might be emptied
		// first)
		// a. Remove the first element from Small; call it l.
		// b. Remove the first element from Large; call it g.
		// c. Set Prob[l] = pl.
		// d. Set Alias[l] = g.
		// e. Set pg : = (pg + pl)−1. (This is a more numerically stable
		// option.)
		...
		// 6. While Small is not empty : This is only possible due to numerical
		// instability.
		// a. Remove the first element from Small; call it l.
		// b. Set Prob[l] = 1.
		while (!Small.isEmpty()) {
