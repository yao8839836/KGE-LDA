...
public class RunLinkLDA_KGE20ng {
	...
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//kge_link_lda_20ng_topics.txt";
		...
		args[0] = "kge_link_lda_20ng_topics";
		...
		ReadWriteFile.writeFile("file//Link_LDA_KGE_feature.txt", sb.toString());
		...
		file = new File("file//Link_LDA_KGE_feature.txt");
		...
		ReadWriteFile.writeFile("file//train_link_lda_kge.arff", training_data);

		ReadWriteFile.writeFile("file//test_link_lda_kge.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_link_lda_kge.arff");
		...
		file = new File("file//test_link_lda_kge.arff");
