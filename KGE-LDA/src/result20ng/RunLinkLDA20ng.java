...
public class RunLinkLDA20ng {
	...
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//link_lda_20ng_topics.txt";
		...
		ReadWriteFile.writeFile("file//Link_LDA_feature.txt", sb.toString());
		...
		file = new File("file//Link_LDA_feature.txt");
		...
		ReadWriteFile.writeFile("file//train_link_lda.arff", training_data);

		ReadWriteFile.writeFile("file//test_link_lda.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_link_lda.arff");
		...
		file = new File("file//test_link_lda.arff");
