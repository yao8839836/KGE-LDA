...
public class RunCTM20ng {
	...
	public static String main(String[] args) throws Exception {
		...
		String content = ReadWriteFile.getTextContent(new File("file//20ng_word_sense_wn18_appear_mod.txt"));
		...
		content = ReadWriteFile.getTextContent(new File("file//20ng_sense_word_wn18_appear_mod.txt"));
		...
		String filename = "file//ctm_20ng_topics.txt";
		...
		ReadWriteFile.writeFile("file//ctm_feature.txt", sb.toString());
		...
		file = new File("file//ctm_feature.txt");
		...
		ReadWriteFile.writeFile("file//train_ctm.arff", training_data);

		ReadWriteFile.writeFile("file//test_ctm.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_ctm.arff");
		...
		file = new File("file//test_ctm.arff");
