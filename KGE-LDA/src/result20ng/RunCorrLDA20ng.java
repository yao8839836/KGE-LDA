...
public class RunCorrLDA20ng {
	...
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//corr_lda_20ng_topics.txt";
		...
		ReadWriteFile.writeFile("file//corr_LDA_feature.txt", sb.toString());
		...
		file = new File("file//corr_LDA_feature.txt");
		...
		ReadWriteFile.writeFile("file//train_corr_lda.arff", training_data);

		ReadWriteFile.writeFile("file//test_corr_lda.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_corr_lda.arff");
		...
		file = new File("file//test_corr_lda.arff");
