...
public class RunCorrLDAohsumed {
	...
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//corr_lda_ohsumed_topics.txt";
		...
		args[0] = "corr_lda_ohsumed_topics";
		...
		ReadWriteFile.writeFile("file//corr_LDA_feature_ohsumed.txt", sb.toString());
		...
		file = new File("file//corr_LDA_feature_ohsumed.txt");
		...
		ReadWriteFile.writeFile("file//train_corr_lda_ohsumed.arff", training_data);

		ReadWriteFile.writeFile("file//test_corr_lda_ohsumed.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_corr_lda_ohsumed.arff");
		...
		file = new File("file//test_corr_lda_ohsumed.arff");
