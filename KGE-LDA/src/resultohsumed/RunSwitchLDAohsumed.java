...
public class RunSwitchLDAohsumed {
	...
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//switch_lda_ohsumed_topics.txt";
		...
		args[0] = "switch_lda_ohsumed_topics";
		...
		ReadWriteFile.writeFile("file//Switch_LDA_feature_ohsumed.txt", sb.toString());
		...
		file = new File("file//Switch_LDA_feature_ohsumed.txt");
		...
		ReadWriteFile.writeFile("file//switch_lda_train_ohsumed.arff", training_data);

		ReadWriteFile.writeFile("file//switch_lda_test_ohsumed.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//switch_lda_train_ohsumed.arff");
		...
		file = new File("file//switch_lda_test_ohsumed.arff");
