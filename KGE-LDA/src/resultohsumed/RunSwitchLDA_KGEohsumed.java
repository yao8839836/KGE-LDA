...
public class RunSwitchLDA_KGEohsumed {
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//kge_switch_lda_ohsumed_topics.txt";
		...
		args[0] = "kge_switch_lda_ohsumed_topics";
		...
		ReadWriteFile.writeFile("file//switch_LDA_KGE_feature_ohsumed.txt", sb.toString());
		...
		file = new File("file//switch_LDA_KGE_feature_ohsumed.txt");
		...
		ReadWriteFile.writeFile("file//train_switch_lda_kge_ohsumed.arff", training_data);

		ReadWriteFile.writeFile("file//test_switch_lda_kge_ohsumed.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_switch_lda_kge_ohsumed.arff");
		...
		file = new File("file//test_switch_lda_kge_ohsumed.arff");
