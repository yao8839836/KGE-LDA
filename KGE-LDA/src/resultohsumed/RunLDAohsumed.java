...
public class RunLDAohsumed {
	...
	public static String main(String[] args) throws Exception {
		...
		String filename = "file//lda_ohsumed_topics.txt";
		...
		ReadWriteFile.writeFile("file//LDA_feature_ohsumed.txt", sb.toString());
		...
		file = new File("file//LDA_feature_ohsumed.txt");
		...
		ReadWriteFile.writeFile("file//train_lda_ohsumed.arff", training_data);

		ReadWriteFile.writeFile("file//test_lda_ohsumed.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_lda_ohsumed.arff");
		...
		file = new File("file//test_lda_ohsumed.arff");
