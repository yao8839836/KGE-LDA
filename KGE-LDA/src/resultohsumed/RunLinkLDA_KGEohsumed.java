...
public class RunLinkLDA_KGEohsumed {
	...
	public static String main(String[] args) throws Exception {
		...
		int dimension = 50;
		LinkLDA_KGE linklda = new LinkLDA_KGE(docs, entities, vocab.size(), entity_list.size(), vector_map, dimension);
		...
		String filename = "file//kge_link_lda_ohsumed_topics.txt";
		...
		args[0] = "kge_link_lda_ohsumed_topics";
		...
		ReadWriteFile.writeFile("file//Link_LDA_KGE_feature_ohsumed.txt", sb.toString());
		...
		file = new File("file//Link_LDA_KGE_feature_ohsumed.txt");
		...
		ReadWriteFile.writeFile("file//train_link_lda_kge_ohsumed.arff", training_data);

		ReadWriteFile.writeFile("file//test_link_lda_kge_ohsumed.arff", test_data);

		/*
		 * 读训练集
		 */

		file = new File("file//train_link_lda_kge_ohsumed.arff");
		...
		file = new File("file//test_link_lda_kge_ohsumed.arff");
		...
		System.out.println(K + "\t" + pmi + "\t" + accuracy);
