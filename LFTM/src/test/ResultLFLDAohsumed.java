...
public class ResultLFLDAohsumed {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			LFTMohsumed.main(args);

			String[] args_new = new String[2];

			args_new[0] = "ohsumed";

			args_new[1] = "data//vocab_ohsumed.txt";
			...
			file = new File("data//ohsumed.theta");
			...
			String training_data = BuildInstances.getTrainingSet(doc_label,
					train_or_test, vector_map, K);

			String test_data = BuildInstances.getTestSet(doc_label,
					train_or_test, vector_map, K);

			ReadWriteFile.writeFile("file//train_lflda_ohsumed.arff",
					training_data);

			ReadWriteFile.writeFile("file//test_lflda_ohsumed.arff", test_data);

			/*
			 * 读训练集
			 */

			file = new File("file//train_lflda_ohsumed.arff");
			...
			file = new File("file//test_lflda_ohsumed.arff");
		...
		ReadWriteFile.writeFile("file//LFLDA_ohsumed_30.txt", sb.toString());
