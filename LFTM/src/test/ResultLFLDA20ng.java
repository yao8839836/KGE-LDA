...
public class ResultLFLDA20ng {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int iter = 0; iter < 10; iter++) {
			...
			args_new[1] = "data//vocab_20ng.txt";
			...
			ReadWriteFile.writeFile("file//train_lflda.arff", training_data);

			ReadWriteFile.writeFile("file//test_lflda.arff", test_data);

			/*
			 * 读训练集
			 */

			file = new File("file//train_lflda.arff");
			...
			file = new File("file//test_lflda.arff");
		...
		ReadWriteFile.writeFile("file//LFLDA_20ng_30.txt", sb.toString());
